        ...
        processSuccessRequest: function (multiRouteModel, e) {
          ...
          axios.post('https://susanin-navigate.herokuapp.com/way/', {
            ...
            .then(response => {
                ...
                const txtwayresp = response.data.way;
                console.log(txtwayresp);
                localStorage.setItem('txt', txtwayresp);
                var txtval = localStorage.getItem("txt");

        Push.create("Сусанин сказал:",{
            body: txtval,
            timeout: 100000,
            onClick: function () {
                window.focus();
